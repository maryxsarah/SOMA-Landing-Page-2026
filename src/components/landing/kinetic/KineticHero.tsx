...
import { KineticAppCta, KineticGuideCta } from './KineticAppCta';
...
export const KineticHero = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-[radial-gradient(130%_78%_at_50%_-8%,#3B2B70_0%,#201A45_42%,#0C0A16_100%)]">
      ...
      <header className="relative z-30 mx-auto max-w-[1280px] px-10 pt-7 max-[900px]:px-5">
        <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-7 max-[900px]:flex max-[900px]:justify-between max-[900px]:gap-3.5">
          ...
          <nav className="flex items-center gap-[30px] text-[17px] font-medium whitespace-nowrap max-[900px]:!hidden">
            {NAV_LINKS.map((link) => (
          ...
          <div className="flex items-center gap-4 justify-self-end">
            <LocalImage
              ...
              width={700}
              height={382}
              className="h-[44px] w-auto brightness-0 invert opacity-80 max-[900px]:!hidden"
            />
            <KineticAppCta placement="header" badgeHeight={42} />
          </div>
        </div>
      </header>

      <section id="top" className="relative mx-auto max-w-[1280px] px-10 pt-11 text-center max-[900px]:px-5">
        {/* Floating chips need the wide canvas to sit either side of the h1;
            below 1240 they're replaced by the compact row further down. */}
        <div className="pointer-events-none absolute inset-x-0 top-0 z-10 h-[470px] max-[1240px]:hidden">
        ...
        <h1
          ...
          data-from="up"
          data-d="1"
          className="k7-serif relative z-20 mx-auto mb-[22px] max-w-[900px] text-[78px] leading-[0.98] font-bold tracking-[-2.4px] max-[900px]:text-[42px] max-[900px]:tracking-[-1.2px]"
        >
        ...
        <div data-r data-from="up" data-d="3" className="relative z-20 flex flex-wrap items-center justify-center gap-[18px]">
          <KineticAppCta placement="hero" badgeHeight={56} className="drop-shadow-[0_14px_30px_rgba(5,8,30,0.6)]" />
          <KineticGuideCta placement="hero" />
        ...
        <p
          ...
          data-from="up"
          data-d="4"
          className="relative z-20 mt-3 text-center text-[13px] text-white/50"
        >
          {t('cta.guideCaption')}
        </p>

        {/* Compact stand-in for the floating chips once the canvas is too
            narrow for them (design's `data-mdevrow`). */}
        <div className="relative z-20 mx-auto mt-[22px] hidden max-w-[340px] flex-wrap items-center justify-center gap-2 max-[1240px]:flex">
          {DEVICE_CHIPS.map((chip) => (
            <span
              key={chip.key}
              className="flex items-center gap-2 rounded-full bg-white/8 py-1.5 pr-3.5 pl-2 text-[12px] font-semibold text-white/86 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.16)]"
            >
              <LocalImage
                src={`/assets/kinetic/site/${chip.img}.png`}
                alt=""
              ...
              />
              {t(`hero.devices.${chip.key}`)}
            </span>
          ))}
        </div>

        <div className="relative mt-9 h-[600px] max-[900px]:flex max-[900px]:h-auto max-[900px]:flex-wrap max-[900px]:items-end max-[900px]:justify-center max-[900px]:gap-3.5">
          <div
            data-px="0.12"
            className="absolute top-[70px] left-1/2 w-[164px] -ml-[560px] animate-[k7Drift_10s_ease-in-out_infinite] max-[900px]:!static max-[900px]:!m-0 max-[900px]:!ml-0 max-[900px]:!mb-0 max-[900px]:!w-[44%] max-[900px]:!max-w-[152px] max-[900px]:!animate-none"
          ...
          <div
            data-px="0.18"
            className="absolute top-[352px] left-1/2 w-[132px] -ml-[500px] animate-[k7DriftB_12s_ease-in-out_infinite] max-[900px]:!hidden"
          ...
          <div
            data-px="0.1"
            className="absolute top-[56px] left-1/2 w-[172px] ml-[392px] animate-[k7Drift_11s_ease-in-out_infinite] max-[900px]:!static max-[900px]:!m-0 max-[900px]:!ml-0 max-[900px]:!mb-0 max-[900px]:!w-[44%] max-[900px]:!max-w-[152px] max-[900px]:!animate-none"
          ...
          <div
            data-px="0.2"
            className="absolute top-[340px] left-1/2 w-[118px] ml-[432px] animate-[k7DriftB_9s_ease-in-out_infinite] max-[900px]:!hidden"
          ...
          <div className="relative flex items-end justify-center gap-5 max-[900px]:order-first max-[900px]:basis-full max-[900px]:gap-0">
            <div
              className="mb-[34px] w-[206px] animate-[k7Drift_9s_ease-in-out_infinite] max-[900px]:!hidden rounded-[34px] bg-[linear-gradient(160deg,#2B2B33,#0E0E14)] p-[7px] shadow-[0_26px_52px_rgba(5,8,30,0.6),inset_0_0_0_1.2px_rgba(255,255,255,0.2)]"
            >
            ...
            <div className="relative w-[294px] animate-[k7Drift_7s_ease-in-out_infinite] max-[900px]:mb-0 max-[900px]:!w-[min(78vw,300px)] rounded-[44px] bg-[linear-gradient(160deg,#2B2B33,#0E0E14)] p-[9px] shadow-[0_38px_74px_rgba(5,8,30,0.7),inset_0_0_0_1.4px_rgba(255,255,255,0.22)]">
            ...
            <div
              className="mb-[34px] w-[206px] animate-[k7Drift_8s_ease-in-out_infinite] max-[900px]:!hidden rounded-[34px] bg-[linear-gradient(160deg,#2B2B33,#0E0E14)] p-[7px] shadow-[0_26px_52px_rgba(5,8,30,0.6),inset_0_0_0_1.2px_rgba(255,255,255,0.2)]"
            >
              <div className="overflow-hidden rounded-[28px] bg-[#EDF3FC]">
                <LocalImage
